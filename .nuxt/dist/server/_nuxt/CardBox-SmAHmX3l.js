...
import { computed, unref, mergeProps, withCtx, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, resolveDynamicComponent, useSSRContext, useSlots, reactive, watch, createTextVNode, withDirectives, vModelText, renderSlot } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderAttr, ssrRenderSlot } from "vue/server-renderer";
import { RouterLink } from "vue-router";
import { h as getButtonColor, _ as _sfc_main$2 } from "./colors-BYRMrYIa.js";
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    computed(() => props.headerIcon ?? mdiCog);
    const submit = (e) => {
      emit("submit", e);
    };
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=CardBox-SmAHmX3l.js.map
