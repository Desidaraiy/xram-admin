...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.DeRFmAsH.mjs').then(interopDefault),
  ...
  "layouts/authenticated.vue": () => import('./_nuxt/authenticated-styles.DUNufjjB.mjs').then(interopDefault),
