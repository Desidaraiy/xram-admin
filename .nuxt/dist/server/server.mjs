...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B9HHfeuz.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-BJ36h8-l.js")
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    component: () => import("./_nuxt/_id_-lBViv4yb.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/index-Bk4lA7Y6.js")
  },
  {
    name: "schedules-id",
    path: "/schedules/:id()",
    component: () => import("./_nuxt/_id_-C_ozcpiQ.js")
  },
  {
    name: "schedules",
    path: "/schedules",
    component: () => import("./_nuxt/index-DayBFUjX.js")
  }
];
...
const layouts = {
  authenticated: () => import("./_nuxt/authenticated-Bg4tTvCJ.js"),
  default: () => import("./_nuxt/default-B8FoTTME.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-jZJWFpO9.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cl-zXCrf.js"));
