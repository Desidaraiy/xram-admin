import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, onServerPrefetch, toValue, defineComponent, provide, createElementBlock, isShallow, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
...
import { mdiShieldAccount, mdiNotificationClearAll, mdiStar, mdiAccountMultiplePlus, mdiValveClosed, mdiChartArc } from "@mdi/js";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_id_-ChVppqWe.js").then((m) => m.default || m)
  },
  {
    name: "admins",
    path: "/admins",
    ...
    component: () => import("./_nuxt/index-DRPHaumE.js").then((m) => m.default || m)
  },
  {
    name: "admins-new",
    path: "/admins/new",
    ...
    component: () => import("./_nuxt/new-Bei1zkMx.js").then((m) => m.default || m)
  },
  {
    name: "advertising-edit-id",
    path: "/advertising/edit/:id()",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta$a == null ? void 0 : __nuxt_page_meta$a.redirect,
    component: () => import("./_nuxt/_id_-CXSusPz2.js").then((m) => m.default || m)
  },
  {
    name: "advertising",
    path: "/advertising",
    ...
    component: () => import("./_nuxt/index-gE3A4ZKu.js").then((m) => m.default || m)
  },
  {
    name: "advertising-new",
    path: "/advertising/new",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta$8 == null ? void 0 : __nuxt_page_meta$8.redirect,
    component: () => import("./_nuxt/new-tBrshODa.js").then((m) => m.default || m)
  },
  {
    name: "demo",
    path: "/demo",
    ...
    component: () => import("./_nuxt/demo-CkNBPfJz.js").then((m) => m.default || m)
  },
  {
    name: "groups",
    path: "/groups",
    ...
    component: () => import("./_nuxt/groups-DbjZ6xF7.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-BlEgoMtr.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login-DKfsf4Oc.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/permission_denied-Ds2EXjcC.js").then((m) => m.default || m)
  },
  {
    name: "pushmailing-edit-id",
    path: "/pushmailing/edit/:id()",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect,
    component: () => import("./_nuxt/_id_-CJWNkHHu.js").then((m) => m.default || m)
  },
  {
    name: "pushmailing",
    path: "/pushmailing",
    ...
    component: () => import("./_nuxt/index-ClpBPdZz.js").then((m) => m.default || m)
  },
  {
    name: "pushmailing-planned",
    path: "/pushmailing/planned",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect,
    component: () => import("./_nuxt/planned-Ba6K5ke3.js").then((m) => m.default || m)
  }
];
...
const proxyBaseUrl = "https://teleosapi.pushmobile.ru/app.php?action=";
const tokenCookieName = "teleosadmintoken";
const useMainStore = defineStore("main", {
  ...
  actions: {
    ...
    async getAdvertsList() {
      ...
      const uniqueArray = [];
      const uniqueAdIds = /* @__PURE__ */ new Set();
      await $fetch(path, {
        method: "POST",
        body: { token: this.userToken }
      }).then((r) => {
...
const layouts = {
  authenticated: () => import("./_nuxt/authenticated-DjBuFjJb.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-DwCtpUwE.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BdebeCVZ.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CMhSeqkf.js").then((r) => r.default || r));
