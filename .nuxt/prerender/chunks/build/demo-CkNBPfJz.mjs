...
import { ref, computed, withCtx, unref, openBlock, createBlock, createVNode, createCommentVNode, createTextVNode, Fragment, renderList, useSSRContext, watch, mergeProps, toDisplayString, useSlots, renderSlot } from 'file:///Users/admin/work/teleos-admin/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSlot } from 'file:///Users/admin/work/teleos-admin/node_modules/vue/server-renderer/index.mjs';
import { mdiChartTimelineVariant, mdiAccountMultiple, mdiCartOutline, mdiChartPie, mdiFinance, mdiReload, mdiMonitorCellphone, mdiCog, mdiClose, mdiCashMinus, mdiCashPlus, mdiReceipt, mdiCreditCardOutline, mdiTrendingUp, mdiTrendingNeutral, mdiTrendingDown, mdiGithub, mdiChevronUp, mdiChevronDown, mdiAlertCircleOutline } from 'file:///Users/admin/work/teleos-admin/node_modules/@mdi/js/commonjs/mdi.js';
import { _ as _sfc_main$c, a as _sfc_main$1$2 } from './SectionMain-oKKzVNTB.mjs';
import { _ as _sfc_main$e, a as _sfc_main$1$1 } from './CardBox-SmAHmX3l.mjs';
import numeral from 'file:///Users/admin/work/teleos-admin/node_modules/numeral/numeral.js';
import { _ as _sfc_main$h, c as colorsOutline, a as colorsBgLight, g as gradientBgPinkRed, b as gradientBgPurplePink } from './colors-BYRMrYIa.mjs';
import { _ as _sfc_main$g } from './BaseLevel-0o1EWMay.mjs';
import { _ as _sfc_main$f } from './TableSampleClients-cZ8HAdYi.mjs';
import { _ as _sfc_main$d } from './SectionTitleLineWithButton-7kpWGLD1.mjs';
...
const datasetObject = (color2, points) => {
  return {
    fill: false,
    borderColor: chartColors.default[color2],
    borderWidth: 2,
    borderDash: [],
    borderDashOffset: 0,
    pointBackgroundColor: chartColors.default[color2],
    pointBorderColor: "rgba(255,255,255,0)",
    pointHoverBackgroundColor: chartColors.default[color2],
    pointBorderWidth: 20,
    pointHoverRadius: 4,
...
const getComputedStyle = (element) => (void 0).getComputedStyle(element, null);
...
(function() {
  ...
  try {
    ...
    (void 0).addEventListener("test", null, options);
    (void 0).removeEventListener("test", null, options);
  } catch (e) {
  }
...
class Animator {
  ...
  _refresh() {
    ...
    this._running = true;
    this._request = requestAnimFrame.call(void 0, () => {
      this._update();
      this._request = null;
      if (this._running) {
        this._refresh();
...
const _sfc_main$b = {
  ...
  setup(__props) {
    const props = __props;
    const root = ref(null);
    Chart.register(LineElement, PointElement, LineController, LinearScale, CategoryScale, plugin_tooltip);
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const componentClass = computed(() => {
      ...
      const baseColor = colorsBgLight[type];
      const base = [
        "border",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["inline-flex items-center capitalize", componentClass.value]
      }, _attrs))}>`);
      if (__props.icon) {
        _push(ssrRenderComponent(_sfc_main$h, {
          ...
          size: __props.small ? 14 : 16
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<span>${ssrInterpolate(__props.text)}</span></div>`);
    };
  }
};
      ...
      _push(ssrRenderComponent(_sfc_main$e, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      ...
                      __props.withButton ? (openBlock(), createBlock("div", { key: 0 }, [
            ...
            _push2(ssrRenderComponent(_sfc_main$g, { mobile: "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              __props.trend ? (openBlock(), createBlock(_sfc_main$g, {
                key: 0,
                class: "mb-3",
                mobile: ""
              }, {
              ...
              createVNode(_sfc_main$g, { mobile: "" }, {
                default: withCtx(() => [
                  createVNode("div", null, [
                    createVNode("h3", { class: "text-lg leading-tight text-gray-500 dark:text-slate-400" }, toDisplayString(__props.label), 1),
                    createVNode("h1", { class: "text-3xl leading-tight font-semibold" }, [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!isDismissed.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          class: [componentClass.value, "px-3 py-6 md:py-3 mb-6 last:mb-0 border rounded transition-colors duration-150"]
        }, _attrs))}>`);
        _push(ssrRenderComponent(_sfc_main$g, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="text-center md:text-left"${_scopeId}>`);
              ...
              return [
                createVNode("div", { class: "flex flex-col md:flex-row items-center" }, [
                  ...
                  createVNode("span", { class: "text-center md:text-left" }, [
                    renderSlot(_ctx.$slots, "default")
                  ])
                ]),
                hasRightSlot.value ? renderSlot(_ctx.$slots, "right", { key: 0 }) : (openBlock(), createBlock(_sfc_main$1$1, {
                  key: 1,
                  icon: unref(mdiClose),
                  outline: __props.outline,
                  small: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$g, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$g, { type: "justify-start" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$1$2, {
                          icon: icon.value.icon,
                          type: icon.value.type,
                          class: "md:mr-6"
                        }, null, _parent4, _scopeId3));
                        _push4(`<div class="text-center space-y-1 md:text-left md:mr-6"${_scopeId3}><h4 class="text-xl"${_scopeId3}> $${ssrInterpolate(__props.amount)}</h4><p class="text-gray-500 dark:text-slate-400"${_scopeId3}><b${_scopeId3}>${ssrInterpolate(__props.date)}</b> via ${ssrInterpolate(__props.business)}</p></div>`);
                      } else {
                        return [
                          ...
                          createVNode("div", { class: "text-center space-y-1 md:text-left md:mr-6" }, [
                            createVNode("h4", { class: "text-xl" }, " $" + toDisplayString(__props.amount), 1),
                            createVNode("p", { class: "text-gray-500 dark:text-slate-400" }, [
                              createVNode("b", null, toDisplayString(__props.date), 1),
                              createTextVNode(" via " + toDisplayString(__props.business), 1)
                            ])
                          ])
                        ];
                      }
                  ...
                  _push3(`<div class="text-center md:text-right space-y-2"${_scopeId2}><p class="text-sm text-gray-500"${_scopeId2}>${ssrInterpolate(__props.name)}</p><div${_scopeId2}>`);
                  ...
                  return [
                    createVNode(_sfc_main$g, { type: "justify-start" }, {
                      default: withCtx(() => [
                        createVNode(_sfc_main$1$2, {
                          icon: icon.value.icon,
                          type: icon.value.type,
                    ...
                    createVNode("div", { class: "text-center md:text-right space-y-2" }, [
                      createVNode("p", { class: "text-sm text-gray-500" }, toDisplayString(__props.name), 1),
                      createVNode("div", null, [
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CardBoxTransaction.vue");
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    computed(
      ...
      // () => props.avatar ?? `https://dummyimage.com/200x200/fff/aaa`
    );
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const pillText = computed(() => {
      var _a;
      return (_a = props.text) != null ? _a : `${props.progress}%`;
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$e, mergeProps({
        class: "mb-6 last:mb-0",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$4, {
                          ...
                          username: __props.name
                        }, null, _parent4, _scopeId3));
                        _push4(`<div class="text-center md:text-left overflow-hidden"${_scopeId3}><h4 class="text-xl text-ellipsis"${_scopeId3}>${ssrInterpolate(__props.name)}</h4><p class="text-gray-500 dark:text-slate-400"${_scopeId3}>${ssrInterpolate(__props.date)} @ ${ssrInterpolate(__props.login)}</p></div>`);
                      } else {
                        return [
                          ...
                          createVNode("div", { class: "text-center md:text-left overflow-hidden" }, [
                            createVNode("h4", { class: "text-xl text-ellipsis" }, toDisplayString(__props.name), 1),
                            createVNode("p", { class: "text-gray-500 dark:text-slate-400" }, toDisplayString(__props.date) + " @ " + toDisplayString(__props.login), 1)
                          ])
                        ];
                      }
                    }),
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CardBoxClient.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: [colorClass.value, "mt-6 mb-6 rounded-2xl py-12 px-6 text-center"]
      }, _attrs))}>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SectionBanner.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {
  __name: "SectionBannerStarOnGitHub",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ bg: "pinkRed" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-3xl text-white mb-6"${_scopeId}> Like the project? Please star on <b${_scopeId}>GitHub</b> ;-) </h1><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1$1, {
              href: "https://github.com/justboil/admin-one-vue-tailwind",
              icon: unref(mdiGithub),
              label: "GitHub",
              target: "_blank",
              "rounded-full": ""
            }, null, _parent2, _scopeId));
            ...
            return [
              createVNode("h1", { class: "text-3xl text-white mb-6" }, [
                createTextVNode(" Like the project? Please star on "),
                createVNode("b", null, "GitHub"),
                createTextVNode(" ;-) ")
              ]),
              createVNode("div", null, [
                createVNode(_sfc_main$1$1, {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SectionBannerStarOnGitHub.vue");
            ...
            _push2(ssrRenderComponent(_sfc_main$c, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6"${_scopeId2}><div class="flex flex-col justify-between"${_scopeId2}><!--[-->`);
                  ssrRenderList(transactionBarItems.value, (transaction, index) => {
                  ...
                  _push3(`<!--]--></div><div class="flex flex-col justify-between"${_scopeId2}><!--[-->`);
                  ssrRenderList(clientBarItems.value, (client) => {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$d, {
                    icon: unref(mdiChartPie),
                    title: "Trends overview"
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$e, {
                    title: "Performance",
                    icon: unref(mdiFinance),
                    "header-icon": unref(mdiReload),
                    class: "mb-6",
                    onHeaderIconClick: fillChartData
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (chartData.value) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$6, {
                    color: "info",
                    icon: unref(mdiMonitorCellphone)
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$e, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$f, null, null, _parent4, _scopeId3));
                      } else {
                        return [
                  ...
                  return [
                    ...
                    createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6" }, [
                      createVNode("div", { class: "flex flex-col justify-between" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(transactionBarItems.value, (transaction, index) => {
                          return openBlock(), createBlock(_sfc_main$5, {
                            ...
                            name: transaction.name,
                            account: transaction.account
                          }, null, 8, ["amount", "date", "business", "type", "name", "account"]);
                        }), 128))
                      ]),
                      createVNode("div", { class: "flex flex-col justify-between" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(clientBarItems.value, (client) => {
                          return openBlock(), createBlock(_sfc_main$3, {
                            ...
                            date: client.created,
                            progress: client.progress
                          }, null, 8, ["name", "login", "date", "progress"]);
                        }), 128))
                      ])
                    ]),
...
//# sourceMappingURL=demo-CkNBPfJz.mjs.map
