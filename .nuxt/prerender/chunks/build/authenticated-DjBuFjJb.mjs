import { g as defineStore, a as useMainStore, d as useCookie, t as tokenCookieName, e as useStyleStore, f as containerMaxW } from './server.mjs';
import { computed, mergeProps, unref, withCtx, createVNode, withModifiers, useSSRContext, ref, createTextVNode, toDisplayString, resolveDynamicComponent, openBlock, createBlock, createCommentVNode } from 'file:///Users/admin/work/teleos-admin/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderVNode } from 'file:///Users/admin/work/teleos-admin/node_modules/vue/server-renderer/index.mjs';
import { mdiLoading, mdiBackburger, mdiForwardburger, mdiMenu, mdiAccount, mdiLogout, mdiThemeLightDark, mdiClose, mdiDotsVertical, mdiChevronUp, mdiChevronDown, mdiMinus, mdiPlus } from 'file:///Users/admin/work/teleos-admin/node_modules/@mdi/js/commonjs/mdi.js';
import { useRouter, RouterLink } from 'file:///Users/admin/work/teleos-admin/node_modules/vue-router/dist/vue-router.node.mjs';
import { _ as _sfc_main$b, h as getButtonColor } from './colors-BYRMrYIa.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-B4HAH-BK.mjs';
import { _ as _sfc_main$c } from './OverlayLayer-Ca6LWwyv.mjs';
import { _ as _sfc_main$d } from './BaseLevel-0o1EWMay.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.item.to) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: (_a = __props.item.to) != null ? _a : null,
          target: (_b = __props.item.target) != null ? _b : null,
        ...
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent("a"), {
          to: (_c = __props.item.to) != null ? _c : null,
          href: (_d = __props.item.href) != null ? _d : null,
          target: (_e = __props.item.target) != null ? _e : null,
          class: ["flex cursor-pointer dark:text-slate-300 dark:hover:text-white", componentClass.value],
          onClick: menuClick
        }, {
          default: withCtx((vSlot, _push2, _parent2, _scopeId) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$d, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center md:text-left"${_scopeId}><b${_scopeId}>\xA9${ssrInterpolate(year.value)}, <a href="https://pushmobile.ru/" target="_blank"${_scopeId}>pushmobile.ru</a></b></div>`);
          } else {
            return [
              createVNode("div", { class: "text-center md:text-left" }, [
                createVNode("b", null, [
                  createTextVNode("\xA9" + toDisplayString(year.value) + ", ", 1),
                  createVNode("a", {
...
//# sourceMappingURL=authenticated-DjBuFjJb.mjs.map
