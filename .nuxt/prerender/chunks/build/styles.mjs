...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.DlcfCieL.mjs').then(interopDefault),
  ...
  "layouts/authenticated.vue": () => import('./authenticated-styles.bRmEItHL.mjs').then(interopDefault),
  ...
  "layouts/authenticated.vue?vue&type=style&index=0&lang.css": () => import('./authenticated-styles.DUNufjjB.mjs').then(interopDefault)
};
